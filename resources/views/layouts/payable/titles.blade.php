    ...
    <div class="row">
        ...
        <div class="col-4">
            ...
            <div class="custom-control custom-checkbox custom-control-inline">
                ...
                <label class="custom-control-label" for="defaultInline2">Pagos</label>
            </div>
            <div class="custom-control custom-checkbox custom-control-inline">
        ...
        <!-- Botões para incluir, alterar e estornar as despesas (acionam modais) -->
        <div class="col-5 text-right">
            ...
            <button id="btnEstornar" class="btn btn-danger" data-toggle="modal" data-target="#ModalEstornar"><i class="far fa-trash-alt"></i> Estornar</button>
        </div>
